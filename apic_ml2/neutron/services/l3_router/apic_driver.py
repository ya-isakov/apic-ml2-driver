...
class ApicL3Driver(apic_driver_api.ApicL3DriverBase):
    ...
    def add_router_interface_postcommit(self, context, router_id,
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                ...
                super(self._plugin.__class__,
                      self._plugin).remove_router_interface(
    ...
    def create_floatingip_postcommit(self, context, fip_context):
        original = fip_context.original
        floatingip = fip_context.current
        port_id = original.get('floatingip', {}).get('port_id')
    ...
    def update_floatingip_precommit(self, context, id, fip_context):
        ...
        fip_context.port_id_list = [port_id]
    ...
    def update_floatingip_postcommit(self, context, id, fip_context):
        ...
        if fip_context.current:
            fip_context.current['status'] = status
